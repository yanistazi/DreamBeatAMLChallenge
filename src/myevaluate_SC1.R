evaluateCV <- function(mypredictor, celllines, response, i_train, nfolds=5 , nrepeats=10 , seed=9182456 , mc.cores=1, ...) {
   ...
   celllines <- celllines[i_train,]
   response <- response[i_train,]
